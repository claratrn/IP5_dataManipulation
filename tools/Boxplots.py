...
# Load the CSV files
# gsm8k_df = pd.read_csv('../result_metrics/openAi/commonsense_qa/all_metrics_GPT_commonsense.csv')
# date_df = pd.read_csv('../result_metrics/openAi/dateUnd/all_metrics_date_GPT.csv')
# commonsense_df = pd.read_csv('../result_metrics/openAi/gsm8k/allmetrics_gsm8k.csv')
# law_df = pd.read_csv('../result_metrics/openAi/mmlu/all_metrics_GPT_LAW.csv')

gsm8k_df = pd.read_csv('../result_metrics/llama2/commonsense_qa/all_metrics_common_Llama2.csv')
date_df = pd.read_csv('../result_metrics/llama2/bigbench/all_metrics_date_Llama2.csv')
commonsense_df = pd.read_csv('../result_metrics/llama2/gsm8k/all_metrics_gsm8k_la.csv')
law_df = pd.read_csv('../result_metrics/llama2/mmlu/all_metrics_law_llama.csv')
